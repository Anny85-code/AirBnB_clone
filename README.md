...
```bash
git clone https://github.com/Anny85-code/AirBnB_clone.git
```
...
## Author
<details>
    <summary>Aniekan Udo</summary>
    <ul>
    <li><a href="https://www.github.com/Anny85-code">Github</a></li>
    <li><a href="https://www.twitter.com/Annyudo8?t=lv6gVd9yOPNOhXvwHbKLSA&s=09">Twitter</a></li>
    <li><a href="mailto:uaniekan@gmail.com">e-mail</a></li>
    </ul>
</details>
